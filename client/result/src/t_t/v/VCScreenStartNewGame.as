...
package t_t.v {
	...
	public class VCScreenStartNewGame extends AVC {
		...
		override public function runSelfTest():void {
			addActionButton(0, APP.lText().get_TEXT(Text.ID_TEXT_GAME_START_OFFLINE));
			addActionButton(1, APP.lText().get_TEXT(Text.ID_TEXT_GAME_START_ONLINE));
			addActionButton(2, APP.lText().get_TEXT(Text.ID_TEXT_EXIT));
			super.runSelfTest();
		}
		
		private function el_actionButtons(targetID:int):void {
			dispatchEvent(ID_E_B_ACTION, [ID_E_B_START_OFFLINE, ID_E_B_START_ONLINE, ID_E_B_EXIT][targetID]);
		}		
		...
		public static const ID_E_B_START_OFFLINE:String = '>ID_E_B_START_OFFLINE';
		public static const ID_E_B_START_ONLINE:String = '>ID_E_B_START_ONLINE';
