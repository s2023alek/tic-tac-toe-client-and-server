...
package t_t.v {
	 ...
	 * @version 0.0.0
	 */
	public class VCScreenPause extends AVC {
		
		//{ ===== CONSTRUCTOR
		
		function VCScreenPause (w:uint, h:uint) {
			this.w = w;
			this.h = h;
			prepareContainer();
		...
		override public function runSelfTest():void {
			addActionButton(0, APP.lText().get_TEXT(Text.ID_TEXT_RESTART_CONFIRM));
			addActionButton(1, APP.lText().get_TEXT(Text.ID_TEXT_RESTART_CANCEL));
			super.runSelfTest();
		}
		...
		*/
		...
		public static const NAME:String = 'VCScreenPause';
